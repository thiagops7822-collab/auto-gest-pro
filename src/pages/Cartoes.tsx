...
export default function Cartoes() {
  ...
  const openEditDespesa = (d: DespesaCartao) => {
    ...
    setDespesaForm({ cartaoId: d.cartaoId, descricao: d.descricao, categoria: d.categoria, valorTotal: numberToCurrency(d.valorTotal), parcelas: String(d.parcelas), dataCompra: d.dataCompra, osVinculadaId: d.osVinculadaId || '' });
